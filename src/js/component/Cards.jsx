...
const arr = [
    {
        img: "https://images.unsplash.com/photo-1719843076878-437479063d53?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        title: 'Small Cabin',
...
const Cards = () => {
    return (
        <div className='container-fluid'>
            <section className='one my-5 bg-tertiary'>
